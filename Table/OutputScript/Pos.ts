...
class Pos{ 
    private mConfigArray:{[key:number]: IPosStruct}  = {};
    constrator(){
        this.InitConfig();
    }
    private InitConfig():void{
		this.mConfigArray[1] = {key:1,name:"天使鱼",pos:{x:100,y:200,z:300,},data:[1,],isSuccess:false,};
    ...
    public GetData(key:number): IPosStruct | undefined{
        return this.mConfigArray[key];
    } 
};
export let PosConfig:Pos = new Pos();
